...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === "success") {
    icon = (
      <CircleCheckIcon aria-hidden="true" className="size-6" color="green"/>
    )
  }
  ...
  if (type === "error") {
    icon = (
      <OctagonXIcon className="text-destructive size-6" aria-hidden="true" />
    )
  }

  if (type === "loading") {
    icon = (
      <Loader2Icon className="animate-spin size-6" aria-hidden="true" />
    )
  }
