                ...
                <div className="p-2 flex">
                    <div className="flex flex-col w-50 mr-2">
                        {personalInfo?.profile  && (
                            <div className="rounded overflow-hidden w-50 h-40">
                            {
                                <img src={personalInfo?.profile?.secure_url} alt="profile"/>
                            }
                            </div>
                        )}    
                        <div className="mt-2 px-1 rounded-full text-center border-2 border-slate-500 bg-gradient-to-r from-teal-900/70 via-teal-600/70 to-teal-950/70">
                    ...
                    <div className="ml-2 w-full admin-container">
                        {personalInfo?.address && (
                            <div>
                                ...
                                <div className="px-2 py-1 w-fit rounded-full border-2 border-slate-500 bg-gradient-to-r from-teal-900/70 via-teal-600/70 to-teal-950/70">
